...
namespace SpeechAgent.Migrations
{
    ...
    [Migration("20251115032942_AddAudioFileSaveDir")]
    partial class AddAudioFileSaveDir
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SpeechAgent.Database.Schemas.LocalSettings", b =>
                {
                    ...
                    b.Property<string>("AudioFileSaveDir")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("C:\\VoiceMedic");
                    ...
                    b.Property<bool>("IsBootPopupBrowserEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
